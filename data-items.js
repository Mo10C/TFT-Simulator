...
(function(){
  ...
  const ADDED = [];
  const ADDED_JA = {};
  const EDITS = {"archangelstaff":{"id":"archangelsstaff"},"dragonclaw":{"id":"dragonsclaw"},"warmogarmor":{"id":"warmogsarmor"},"thiefssparringglovess":{"id":"thiefsgloves"},"r_archangel":{"id":"r_archangelsstaff"},"trinityforce":{"imgUrl":"https://tftips.b-cdn.net/item/4_ornninfinityforce.avif?v=1"},"statikkshiv_artifact":{"id":"statikkshiv"},"snipersfocus":{"imgUrl":"https://tftips.b-cdn.net/item/9_ornnhorizonfocus.avif?v=1"},"flickerblade":{"id":"navoriflickerblade"},"rapidfirecannon_artifact":{"id":"rapidfirecannon"},"unendingdespair":{"id":"theindomitable"},"everlastingpact":{"id":"eternalpact"},"dusksblessing":{"id":"aegisofdusk"},"dawnsblessing":{"id":"aegisofdawn"},"hatjuice":{"id":"cappajuice"},"crown_of_demacia":{"imgUrl":"https://tftips.b-cdn.net/item/9_crownofdemacia.avif?v=1","type":"completed"},"tacticians_crown":{"id":"forceofnature"},"emblem_darkstar":{"id":"emblem_fae","imgUrl":"https://tftips.b-cdn.net/item/18_emblemfae.avif?v=1","jaName":"フェイの紋章"}};
