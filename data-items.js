...
/* ── アイテム日本語名 ── */
const ITEM_JA = {
  'B.F. Sword': 'B.F.ソード', 'Recurve recurvebow': 'リカーブボウ', 'Needlessly Large needlesslylargerod': 'ムダニデカイロッド',
  'tearofthegoddess of the Goddess': '女神の涙', 'chainvest Vest': 'チェインベスト', 'Negatron negatroncloak': 'ネガトロンクローク',
  "Giant's giantbelt": 'ジャイアントベルト', 'Sparring sparringglovess': 'スパーリンググローブ', 'deathblade': 'デスブレード',
  ...
  'powergauntlet': 'ストライカー フレイル', "Thief's sparringglovess": '盗賊のグローブ',
...
/* ── 素材アイテム ── */
const ITEMS=[
  {id:'bfsword', name:'B.F.ソード', icon:'⚔️', type:'comp', imgId: 1}, 
  {id:'recurverecurvebow', name:'Recurve recurvebow', icon:'🏹', type:'comp', imgId: 2},
  {id:'needlesslylargerod', name:'Needlessly Large needlesslylargerod', icon:'🔮', type:'comp', imgId: 3}, 
  {id:'tearofthegoddess', name:'tearofthegoddess of the Goddess', icon:'💧', type:'comp', imgId: 4},
  {id:'chainvest', name:'chainvest Vest', icon:'🛡️', type:'comp', imgId: 5}, 
  {id:'negatroncloak', name:'Negatron negatroncloak', icon:'🧥', type:'comp', imgId: 6},
  {id:'giantbelt', name:"Giant's giantbelt", icon:'💖', type:'comp', imgId: 7}, 
  {id:'sparringgloves', name:'Sparring sparringglovess', icon:'🥊', type:'comp', imgId: 9},
  {id:'spatula', name:'Spatula', icon:'🍳', type:'comp', imgId: 8},
  {id:'fryingpan', name:'Frying fryingpan', icon:'🥘', type:'comp', imgId: 10}
];
...
const ITEM_RECIPES = {
  ...
  'bfsword_recurvebow':{id:'giantslayer', name:'Giant Slayer', icon:'🪚', imgId: 12},
  'bfsword_needlesslylargerod':{id:'gunblade', name:'Hextech Gunblade', icon:'🔫', imgId: 13}, 
  'bfsword_tearofthegoddess':{id:'shojin', name:'spearofshojin', icon:'🔱', imgId: 14},
  'bfsword_chainvest':{id:'edgeofnight', name:'guardianangel', icon:'🌑', imgId: 15}, 
  'bfsword_negatroncloak':{id:'bloodthirster', name:'Bloodthirster', icon:'🧛', imgId: 16},
  'bfsword_giantbelt':{id:'steraksgage', name:"steraksgage", icon:'💪', imgId: 17}, 
  'bfsword_sparringgloves':{id:'infinityedge', name:'Infinity Edge', icon:'✨', imgId: 19},
  'recurvebow_recurvebow':{id:'rapidfirecannon', name:'rapidfirecannon', icon:'🔥', imgId: 22}, 
  'recurvebow_needlesslylargerod':{id:'guinsoo', name:"Guinsoo's Rageblade", icon:'☄️', imgId: 23},
  'recurvebow_tearofthegoddess':{id:'statikk', name:'statikkshiv', icon:'⚡', imgId: 24}, 
  'recurvebow_chainvest':{id:'titans', name:"Titan's Resolve", icon:'🗿', imgId: 25},
  'recurvebow_negatroncloak':{id:'runaan', name:"runaanshurricane", icon:'🌪️', imgId: 26}, 
  'recurvebow_giantbelt':{id:'nashor', name:"leviathan", icon:'🦷', imgId: 27},
  'recurvebow_sparringgloves':{id:'lastwhisper', name:'Last Whisper', icon:'🏹', imgId: 29},
  'needlesslylargerod_needlesslylargerod':{id:'rabadon', name:"Rabadon's Deathcap", icon:'🎩', imgId: 33}, 
  'needlesslylargerod_tearofthegoddess':{id:'archangel', name:"Archangel's Staff", icon:'👼', imgId: 34},
  'needlesslylargerod_chainvest':{id:'crownguard', name:'Crownguard', icon:'👑', imgId: 35}, 
  'needlesslylargerod_negatroncloak':{id:'ionic', name:'Ionic Spark', icon:'🌩️', imgId: 36},
  'needlesslylargerod_giantbelt':{id:'morello', name:'Morellonomicon', icon:'📜', imgId: 37}, 
  'needlesslylargerod_sparringgloves':{id:'jeweled', name:'Jeweled Gauntlet', icon:'💎', imgId: 39},
  'tearofthegoddess_tearofthegoddess':{id:'bluebuff', name:'Blue Buff', icon:'🟦', imgId: 44}, 
  'tearofthegoddess_chainvest':{id:'vow', name:"frozenheart", icon:'🤝', imgId: 45},
  'tearofthegoddess_negatroncloak':{id:'adaptive', name:'Adaptive Helm', icon:'🪖', imgId: 46}, 
  'tearofthegoddess_giantbelt':{id:'redemption', name:'Redemption', icon:'😇', imgId: 47},
  'tearofthegoddess_sparringgloves':{id:'hoj', name:'unstableconcoction', icon:'⚖️', imgId: 49},
  'chainvest_chainvest':{id:'bramble', name:'Bramble Vest', icon:'🌵', imgId: 55}, 
  'chainvest_negatroncloak':{id:'gargoyle', name:'Gargoyle Stoneplate', icon:'🗿', imgId: 56},
  'chainvest_giantbelt':{id:'sunfire', name:'redbuff', icon:'☀️', imgId: 57}, 
  'chainvest_sparringgloves':{id:'steadfast', name:'nightharvester', icon:'❤️', imgId: 59},
  'negatroncloak_negatroncloak':{id:'dragon', name:"Dragon's Claw", icon:'🐉', imgId: 66}, 
  'negatroncloak_giantbelt':{id:'evenshroud', name:'spectralgauntlet', icon:'🦇', imgId: 67},
  'negatroncloak_sparringgloves':{id:'quicksilver', name:'Quicksilver', icon:'🧣', imgId: 69}, 
  'giantbelt_giantbelt':{id:'warmog', name:"Warmog's Armor", icon:'🌿', imgId: 77}, 
  'giantbelt_sparringgloves':{id:'guardbreaker', name:'powergauntlet', icon:'🔨', imgId: 79}, 
  'sparringgloves_sparringgloves':{id:'thiefs', name:"Thief's sparringglovess", icon:'🧤', imgId: 99},
  'spatula_bf':{id:'emblem_darkstar', name:'Dark Star Emblem', icon:'🛡️', imgId: 81, grantedTrait: 'Dark Star'}, 
  'spatula_recurvebow':{id:'emblem_timebreaker', name:'pulsefire Emblem', icon:'🏹', imgId: 82, grantedTrait: 'Timebreaker'},
  'spatula_needlesslylargerod':{id:'emblem_stargazer', name:'Stargazer Emblem', icon:'🔮', imgId: 83, grantedTrait: 'Stargazer'}, 
  'spatula_tearofthegoddess':{id:'emblem_spacegroove', name:'SpaceGroove Emblem', icon:'💧', imgId: 84, grantedTrait: 'Space Groove'},
  'spatula_chainvest':{id:'emblem_meeple', name:'astronaut Emblem', icon:'🛡️', imgId: 85, grantedTrait: 'Meeple'}, 
  'spatula_negatroncloak':{id:'emblem_arbiter', name:'favored Emblem', icon:'🧥', imgId: 86, grantedTrait: 'Arbiter'},
  'spatula_giantbelt':{id:'emblem_primordian', name:'Primordian Emblem', icon:'💖', imgId: 87, grantedTrait: 'Primordian'}, 
  'spatula_sparringgloves':{id:'emblem_nova', name:'drx Emblem', icon:'🥊', imgId: 89, grantedTrait: 'N.O.V.A.'},
  'spatula_spatula':{id:'tacticians_crown', name:"forceofnature", icon:'👑', imgId: 88, teamSizeBonus: 1},
  'fryingpan_bf':{id:'emblem_marauder', name:'meleetrait Emblem', icon:'🛡️', imgId: 91, grantedTrait: 'Marauder'},
  'fryingpan_recurvebow':{id:'emblem_challenger', name:'astrait Emblem', icon:'🏹', imgId: 92, grantedTrait: 'Challenger'},
  'fryingpan_needlesslylargerod':{id:'emblem_voyager', name:'flextrait Emblem', icon:'🔮', imgId: 93, grantedTrait: 'Voyager'},
  'fryingpan_tearofthegoddess':{id:'emblem_shepherd', name:'summontrait Emblem', icon:'💧', imgId: 94, grantedTrait: 'Shepherd'},
  'fryingpan_chainvest':{id:'emblem_bastion', name:'resisttank Emblem', icon:'🛡️', imgId: 95, grantedTrait: 'Bastion'},
  'fryingpan_negatroncloak':{id:'emblem_vanguard', name:'shieldtank Emblem', icon:'🧥', imgId: 96, grantedTrait: 'Vanguard'},
  'fryingpan_giantbelt':{id:'emblem_brawler', name:'hptank Emblem', icon:'💖', imgId: 97, grantedTrait: 'Brawler'},
  'fryingpan_sparringgloves':{id:'emblem_rogue', name:'assassintrait Emblem', icon:'🥊', imgId: 98, grantedTrait: 'Rogue'},
