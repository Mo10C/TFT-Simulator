...
const TRAIT_DESCS = {
  ...
  'Timebreaker': '(2) 敗北時に無料リロールを獲得する。勝利時には時空の核にXPを蓄積する(ステージに応じて増加)。\n(3) さらに、味方の攻撃速度が25%増加する。\n(4) さらに、「タイムブレーカー」の攻撃速度が追加で50%増加する\n\n敗北時のリロール: 1\n勝利時のXP: 2',
...
const ARBITER_CAUSES = [
  { id: 'c1', text: '各「アービター」の体力が初めて40%未満になったとき' },
  { id: 'c2', text: '戦闘開始時: 獲得予定の利子ごとに、さらに' },
  { id: 'c3', text: '戦闘開始時: 「アービター」のスターレベルごとに' },
  { id: 'c4', text: '「アービター」が10回ダメージを与えたとき' },
  { id: 'c5', text: '「アービター」が50マナを消費すると' },
  { id: 'c6', text: '「アービター」が3回攻撃すると' },
  { id: 'c7', text: '戦闘開始時: 直前の戦闘準備フェーズ中にリロールした場合' },
  { id: 'c8', text: '4秒ごとに' },
  { id: 'c9', text: '敵が倒されると' }
];
...
const ARBITER_EFFECTS = [
  { id: 'e1', text: 'すべての「アービター」の攻撃速度がX%増加する。' },
  { id: 'e2', text: '戦闘終了時、X%の確率でレオナを1体獲得する。' },
  { id: 'e3', text: 'すべての「アービター」Xマナを獲得する。' },
  { id: 'e4', text: 'すべての「アービター」の魔力がX増加する。' },
  { id: 'e5', text: '戦闘終了時、25%の確率で3ゴールドを獲得する。' },
  { id: 'e6', text: 'すべての「アービター」の最大体力が恒久的にX増加する。' },
  { id: 'e7', text: 'すべての「アービター」の物理防御と魔法防御がX増加する。' },
  { id: 'e8', text: '戦闘終了時、X%の確率で無料リロールをX回獲得する。' },
  { id: 'e9', text: 'X秒間、すべての「アービター」が最大体力のX%にあたる耐久値を持つシールドを獲得する。' }
];
