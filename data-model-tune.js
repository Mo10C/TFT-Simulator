...
const MODEL_TUNE = {
  ...
  karma: { scale:1.1 },   // カルマ
  kobuko: { scale:0.71, x:0.4, z:0.01, rotY:-18 },   // コブコ
  leona: { z:-0.75 },   // レオナ
  ornn: { z:-0.66 },   // オーン
  ...
  kayle: { x:-0.01, y:-0.27, rotY:-21 },   // ケイル
  leblanc: { scale:1.11, x:0.45, y:-0.2 },   // ルブラン
  murkwolf: { scale:0.49, x:-0.19, rotY:2 },   // マークウルフ
  ...
  rammus: { z:-0.17 },   // ラムス
  rengar: { scale:0.94, x:0.13, z:-0.17, rotY:10 },   // レンガー
  ...
  brambleback: { scale:0.79, x:-0.2, z:0.3, rotY:-111 },   // ブランブルバック
  ...
  draven: { x:-0.1 },   // ドレイヴン
  elderdragon: { scale:1.07, x:-1.03, y:-0.83, z:-0.23, rotY:-4 },   // エルダードラゴン
